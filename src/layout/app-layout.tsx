...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiMapPin, FiCalendar } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Venue', path: '/venues', entity: 'venue', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
